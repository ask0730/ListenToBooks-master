<template>
    <gui-page :customHeader="true" :customFooter="true">
        ...
        <template v-slot:gBody>
            ...
            <!--			二级导航-->
            <SecondaryClassificationNav v-if="navItems.length" :navData="category3NavItems" :category1Name="navItems[category1NavIndex].name" :category1Id="navItems[category1NavIndex].id"></SecondaryClassificationNav>
            <!--			商品模块-->
            <GoodsCard v-for="(item,index) in category1IdData" :goodsData="item" :key="index"></GoodsCard>
        </template>
